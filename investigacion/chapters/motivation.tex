...
gold mine has produced a new sector where different vendors have created videogames related
...
The aim of the article is to analyze the advantages of the \emph{Vulkan} engine \gls{api} and compare it among other
available technologies in the market. This article also shows introduces which are the required tools for
developing with \emph{Vulkan}. As the engine is very young a benchmark test is proposed for verifying that the
\gls{sdk} is, at least, as good as its ancestor.
\end{abstract}
